...
import base.framework.response.JsonResponse;
import base.framework.response.Response;
import base.framework.request.enums.Method;
import base.framework.request.Header;
import base.framework.request.Helper;
import base.framework.request.Request;
import base.framework.request.exceptions.RequestNotValidException;
...
//            Response response = new JsonResponse(responseMap);
            ...
            /*Object response = */DIEngine.processRequest(request);
//            Response responseOut = new JsonResponse(response);
//
